...
FOSE_SAFAR_NAME = os.getenv('FOSE_SAFAR_NAME', 'FOSE Safar')
FOSE_SAFAR_ADDRESS = os.getenv(
    'FOSE_SAFAR_ADDRESS',
    'Résidence Amwaj, Sidi Rahal, Maroc',
)
FOSE_SAFAR_COORDINATES = os.getenv('FOSE_SAFAR_COORDINATES', '33.455229, -8.0011702')
FOSE_SAFAR_CONTACT_EMAIL = os.getenv(
    'FOSE_SAFAR_CONTACT_EMAIL',
    EMAIL_HOST_USER or 'contact@fosesafar.local',
)
FOSE_SAFAR_CONTACT_PHONE = os.getenv('FOSE_SAFAR_CONTACT_PHONE', '')
FOSE_SAFAR_CHECK_IN = os.getenv('FOSE_SAFAR_CHECK_IN', '15:00')
FOSE_SAFAR_CHECK_OUT = os.getenv('FOSE_SAFAR_CHECK_OUT', '12:00')
FOSE_SAFAR_GUARANTEE_AMOUNT = os.getenv('FOSE_SAFAR_GUARANTEE_AMOUNT', '1000.00')
